...
- Created an #emph[Systematic-Literature Review (SLR)]
...
- Screened 2,301 potentially relevant studies from eight digital
  libraries considering publications between 2015 and 2024
...
- Comprehensive #strong[Understanding of how ML] can be used to support
  the Migration
...
- Automation of #emph[Business Processes (BP)] discovery and refactoring
...
- Enhancing data accessibility through industry collaboration,
  privacy-preserving data-sharing frameworks and development of
